...
import WorkplaceCodeSection from '@/components/sections/WorkplaceCodeSection';
...
export default function AboutPage() {
  ...
  useEffect(() => {
    // Journey 데이터 불러오기 (예정일정 제외)
    const items = getJourneyItems();
    // 예정일정이 아닌 항목만 필터링하고 순서대로 정렬
  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        {/* Workplace Code Section */}
        <WorkplaceCodeSection />
      </main>
      <Footer />
    </>
  );
