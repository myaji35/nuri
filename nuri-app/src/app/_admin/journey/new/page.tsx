...
import { addJourneyItem, getJourneyItems } from '@/lib/journeyStore';
...
export default function NewJourneyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const currentItems = getJourneyItems();
      ...
      console.error('Failed to save journey item:', error);
      setSaving(false);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">새 이정표 추가</h1>
        <p className="text-gray-600 mt-2">회사 역사에 새로운 이정표를 추가합니다</p>
      </div>
