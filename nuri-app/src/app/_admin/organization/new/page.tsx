...
import { addMember, getDepartments, type Department } from '@/lib/organizationStore';
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">새 조직원 추가</h1>
        <p className="text-gray-600 mt-2">새로운 조직원 정보를 입력합니다</p>
      </div>
